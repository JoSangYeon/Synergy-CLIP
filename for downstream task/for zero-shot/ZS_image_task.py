...
flowers_label_tag = {
    ...
    20: "Peruvian lily",
    21: "Balloon flower",
    22: "Giant white arum lily",
    23: "Fire lily",
    24: "Pincushion flower",
    25: "Fritillary",
    26: "Red ginger",
    27: "Grape hyacinth",
    28: "Corn poppy",
    29: "Prince of Wales feathers",
    30: "Stemless gentian",
    31: "Artichoke",
    32: "Sweet william",
    33: "Carnation",
    ...
    57: "Sunflower",
    58: "Pelargonium",
    59: "Bishop of Llandaff",
    60: "Gaura",
    61: "Geranium",
    62: "Orange dahlia",
    63: "Pink-yellow dahlia",
    64: "Cautleya spicata",
    65: "Japanese anemone",
    66: "Black-eyed Susan",
    67: "Silene",
...
def get_ZS_set(DATASET, IS_BASE, IS_CAPTIONED):
    if DATASET == 'CIFAR-10':
        ...
        valid_dataset = datasets.OxfordIIITPet(root='./data', split='test', download=True, transform=transform)
        ...
        transforms = torchvision.transforms.Compose([
            ...
            torchvision.transforms.RandomHorizontalFlip(),  # Basic augmentation
        ...
        valid_dataset = ImageNet_Dataset(data=imagenet_valid_data, img_processor=transforms)
    else:
        return None, None
...
def ZS_validate(model, DATASET, valid_dataset, txt_processor, try_num=128):
    ...
    if DATASET == 'CIFAR-10':
        ...
        text_list = [prompt.format(tag) for label, tag in flowers_label_tag.items()]
    elif DATASET == 'Pets':
        text_list = [prompt.format(tag) for label, tag in pets_label_tag.items()]
    elif DATASET == 'ImageNet':
        text_list = [prompt.format(tag) for label, tag in imagenet_label_tag.items()]
...
def main():
    ...
    valid_dataset, txt_processor, model = get_ZS_set(DATASET, IS_BASE, IS_CAPTIONED)
...
if __name__ == "__main__":
    ...
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 7 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 8 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 9 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-10

    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 7 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 8 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 9 --IS_BASE True --IS_CAPTIONED True --DATASET CIFAR-100


    ### IS_BASE False | IS_CAPTIONED True
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 11 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 12 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 13 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-10

    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 11 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 12 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 13 --IS_BASE False --IS_CAPTIONED True --DATASET CIFAR-100


    ### IS_BASE True | IS_CAPTIONED False
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 25 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 26 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 27 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-10

    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 25 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 26 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 27 --IS_BASE True --IS_CAPTIONED False --DATASET CIFAR-100


    ### IS_BASE False | IS_CAPTIONED False
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 49 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 50 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-10
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 51 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-10

    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 49 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 50 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-100
    CUDA_VISIBLE_DEVICES=0 python ZS_image_task.py --SEED 51 --IS_BASE False --IS_CAPTIONED False --DATASET CIFAR-100
